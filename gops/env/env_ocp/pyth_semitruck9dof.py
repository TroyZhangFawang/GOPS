...
class SimuSemiTruck9dof(PythBaseEnv):
    metadata = {
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(SimuSemiTruck9dof, self).__init__(work_space=work_space, **kwargs)
        ...
        done_default = [3, 2, np.pi / 2]  # delta_y, delta_vx, delta_phi
    ...
    def reset(
        ...
        **kwargs,
        ...
        self.ref_points_2 = self.ref_points
    ...
    def get_obs(self) -> np.ndarray:
        ...
        ref_u1_tf = self.ref_points[:, 3] - self.state[3]
        ...
        ref_u2_tf = self.ref_points[:, 3] - self.state[3]
        ...
        ego_obs = np.concatenate(
            ([ref_x_tf[0], ref_y_tf[0], ref_phi_tf[0], ref_u1_tf[0]], [ref_x2_tf[0], ref_y2_tf[0], ref_phi2_tf[0], ref_u2_tf[0]], self.state[0:8]))
        # ref_obs: [
        # delta_x, delta_y, delta_phi, delta_u (of the second to last reference point)
        # ]
        ref_obs = np.stack((ref_x_tf, ref_y_tf, ref_phi_tf, ref_u1_tf), 1)[1:].flatten()
...
def env_creator(**kwargs):
    ...
    """
    return SimuSemiTruck9dof(**kwargs)
