    ...
    def __init__(
        ...
        **kwargs,
        ...
        if work_space is None:
            ...
            # 用高斯分布去采样
            init_high = np.array([100, 10, 1,30, 10, 0.5, 0.1, 0.5,  0.1, 0.1, 0.1, 0.1 ], dtype=np.float32)
            init_low = np.array([0, -10, -1, 0, -10, -0.5, -0.1, -0.5,  -0.1, -0.1, -0.1, -0.1], dtype=np.float32)
