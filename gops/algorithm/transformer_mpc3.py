...
class TRANSFORMERMpc3(AlgorithmBase):
    ...
    def _compute_loss_policy(self, data):
        ...
        for step in range(self.forward_step):
            o_clip = o[:, :self.state_dim + (self.forward_step-step) * self.ref_obs_dim]
            a = self.networks.policy(o_clip)
