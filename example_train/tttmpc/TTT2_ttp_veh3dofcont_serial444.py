...
if __name__ == "__main__":
    ...
    parser.add_argument("--algorithm", type=str, default="TTTMpc2")
    ...
    parser.add_argument("--policy_func_type", type=str, default="TTP")
    ...
    parser.add_argument(
        "--save_folder",
        type=str,
        default=r"D:\GOPS-TMPC\results\pyth_veh3dofconti\TTTMPC2\TTTMPC2" + "seed-42345-" + name,
