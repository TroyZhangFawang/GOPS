...
if __name__ == "__main__":
    ...
    parser.add_argument('--value_conv_type', type=str, default='type_5')
    ...
    parser.add_argument('--policy_conv_type', type=str, default='type_5')
    ...
    parser.add_argument("--buffer_max_size", type=int, default=50_00)
