...
# Parameters Setup
    ...
    parser.add_argument("--algorithm", type=str, default="DSACTDiffusion", help="RL algorithm")
    ...
    parser.add_argument(
        "--reward_scale", type=float, default=1, help="reward scale factor"
    )
    parser.add_argument(
    ...
    parser.add_argument("--vector_env_num", type=int, default=5, help="Number of vector envs")
    parser.add_argument("--vector_env_type", type=str, default="async", help="Type of vector envs")
    parser.add_argument("--gym2gymnasium", type=bool, default=True, help="Convert Gym-style env to Gymnasium-style env")
    ...
    parser.add_argument("--policy_w", type=float, default=1.2)
    ...
    parser.add_argument(
        "--eval_save", type=str, default=False, help="save evaluation data"
    )
