...
if __name__ == "__main__":
    ...
    parser.add_argument("--algorithm", type=str, default="TRANSStolenMpc")
    parser.add_argument("--pre_horizon", type=int, default=20)
    parser.add_argument("--enable_cuda", default=False)
    parser.add_argument("--seed", default=42345)
    ################################################
    ...
    parser.add_argument("--d_model", type=int, default=256)### 256大概是45w参数量
    # parser.add_argument("--d_model", type=int, default=128)### 128大概是18w参数量 由于ttt，mamba，rnn都是双向，双向后参数量约为40w，改为256合适
    ...
    parser.add_argument(
        "--save_folder",
        type=str,
        default=r"D:\GOPS-TMPC\results\pyth_veh3dofconti\TP7\TP7" + "seed-42345-" + name,
        # default="/home/server0/桌面/zjj/diff-power-gops-qloss-0304/diff-power-gops-qloss/results/DDAC/hopper20-no",
    )
