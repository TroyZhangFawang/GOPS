...
#
#  Description: example for fpisac + veh3doftracking_detour + mlp + off_serial
#  Update Date: 2024-05-16, Zheng Zhilong: create example
...
if __name__ == "__main__":
    ...
    parser.add_argument("--algorithm", type=str, default="FPISAC", help="RL algorithm")
    ...
    parser.add_argument("--pf", type=float, default=0.05)
    parser.add_argument("--init_t", type=float, default=1.0)
    parser.add_argument("--t_increase_factor", type=float, default=1.1)
    parser.add_argument("--t_update_delay", type=int, default=5000)
