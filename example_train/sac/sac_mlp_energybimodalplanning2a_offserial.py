...
if __name__ == "__main__":
    ...
    parser.add_argument("--env_id", type=str, default="pyth_energybimodalplanning2a0529", help="id of environment")
    ...
    parser.add_argument("--alpha_learning_rate", type=float, default=3e-3)
