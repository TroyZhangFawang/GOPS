...
from gops.sys_simulator.sys_run import PolicyRunner_CoSimulation_Disturbance_Compare
import numpy as np
...
runner = PolicyRunner_CoSimulation_Disturbance_Compare(
    log_policy_dir_list=[result_path1, result_path2],#
    trained_policy_iteration_list=["1000000", "1000000"],#
    is_init_info=True,
    init_info={"init_state": [0, 0.0, 0.047, -0.5, 0, 0, 0, 0, 0, 0, 0, 0, 0], "ref_time":0.0, "ref_num": 0, 'u_num':0, 'slope_num':1}, #
    save_render=False,
